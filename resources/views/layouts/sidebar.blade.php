...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ asset('js/my-style.js') }}" defer></script>
            ...
            <div class="sidebar-header">
                ...
                <div class="mx-auto d-block">
                    <div class="user-panel">
                        <img src="{{ URL::asset('/users/images/no-image.png') }}" class="img img-circle elevation-2"
                            alt="User Image">
                        <a class="d-block mt-2"> {{ Auth::user()->username }} </a>
                        <a class="d-block mb-2">{{ date('l') }},
                            {{ date('d') }}-{{ date('m') }}-{{ date('y') }} </a>
                    </div>
                </div>
            </div>
